...
class ApiEndpoints {
  ...
  static const String resetOldPassword =
      '/$hrContext/auth/reset-password-with-old-password';
  ...
  static String markAttendance(int employeeId) =>
      '/$hrContext/attendance/mark-attendance/$employeeId';
  static String getAttendanceById(int attendanceId) =>
      '/$hrContext/attendance/get/list/$attendanceId';
  static String getEmployeePunchingDetails(int employeeId) =>
      '/$hrContext/attendance/employee/$employeeId';
  static const String punchIn =
      '/$hrContext/attendance/punch-in'; // Legacy - use markAttendance instead
  static const String punchOut =
      '/$hrContext/attendance/punch-out'; // Legacy - use markAttendance instead
  ...
  static const String updateLeaveBalance =
      '/$hrContext/leaves/updateleavebalance';
  static const String deleteLeaveBalance =
      '/$hrContext/leaves/deleteleavebalance';

  // Geofencing endpoints
  static const String geofencingConfig = '/$hrContext/geofencing-config';
  static const String geofencingEmployeeLocation =
      '/$hrContext/geofencing-employee-location';
  static String geofencingEmployeeConfigByEmployee(int employeeId) =>
      '/$hrContext/geofencing-config/employee/$employeeId';
  static const String geofencingValidate =
      '/$hrContext/geofencing-config/validate';

  // Dashboard endpoints
  static const String dashboard = '/$hrContext/dashboard';
  static const String clientStatistics =
      '/$hrContext/dashboard/client-statistics';
  static const String clientGraphs =
      '/$hrContext/dashboard/client-statistics/graphs';
  static const String vendorStatistics =
      '/$hrContext/dashboard/vendor/vendor-statistics';
  static const String vendorGraphs =
      '/$hrContext/dashboard/vendor/vendor-statistics/graphs';
  static const String employeeStatistics =
      '/$hrContext/dashboard/employee-statistics';
  ...
  static const String salaryStructureBulkUpload =
      '/$hrContext/salary-structure/bulk/upload';
  static const String salaryStructureTransactions =
      '/$hrContext/salary-structure';
  static const String salaryStructureTransactionById =
      '/$hrContext/salary-structure/transactions';
  static const String salaryStructureBulkStatusUpdate =
      '/$hrContext/salary-structure/transactions/status/bulk';
  static const String salaryStructureUpdateTransaction =
      '/$hrContext/salary-structure/transactions';
  ...
  static const String subscriptionModuleGetById =
      '/$hrContext/subscription-module';
  static const String subscriptionModuleCreate =
      '/$hrContext/subscription-module';
  static const String subscriptionModuleUpdate =
      '/$hrContext/subscription-module';
  static const String subscriptionModuleDelete =
      '/$hrContext/subscription-module';
  ...
  static const String tenantSubscriptionCreate =
      '/$hrContext/tenant-subscription';
  static const String tenantSubscriptionUpdate =
      '/$hrContext/tenant-subscription';
  ...
  static const String paymentTrackingGetById =
      '/$hrContext/payment-tracking/invoice';
  static const String paymentTrackingUpdate = '/$hrContext/payment-tracking';
  static const String paymentTrackingReceipt =
      '/$hrContext/payment-tracking/receipt';
  static const String paymentTrackingDelete = '/$hrContext/payment-tracking';

  // Vendor payment tracking endpoints
  static const String vendorPaymentTracking =
      '/$hrContext/vendor-payment-tracking';
